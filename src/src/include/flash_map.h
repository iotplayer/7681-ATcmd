...
#define FLASH_OFFSET_STA_XIP_FW_START    (0x30000)             //224KB  (STA:XIP+OVL)
#define FLASH_OFFSET_RESERVE_5_START    (0x68000)             //4KB

#define FLASH_OFFSET_AP_FW_START        (0x69000)             //64KB
#define FLASH_OFFSET_RESERVE_6_START    (0x79000)             //4KB
#define FLASH_OFFSET_AP_XIP_FW_START    (0x7A000)             //224KB  (AP:XIP+OVL)
#define FLASH_OFFSET_RESERVE_7_START    (0xB2000)             //4KB
...
#define FLASH_OFFSET_STA_FW_START        (0x1F000)             //64KB
#define FLASH_OFFSET_RESERVE_4_START    (0x2F000)             //4KB
#define FLASH_OFFSET_STA_XIP_FW_START    (0x30000)             //120KB  (STA:XIP+OVL)
...
#define FLASH_OFFSET_OTA_START             (0x81000)             //188KB
#define FLASH_OFFSET_RESERVE_9_START (0xB0000)             //4KB
#define FLASH_OFFSET_END                         (0xB0000)             //0KB
...
//cloud client configation
#define FLASH_COM_CFG_CLOUD_DEVID             (0xE9)
#define FLASH_COM_CFG_CLOUD_DEVID_LEN            (0x8)

#define FLASH_COM_CFG_CLOUD_DEVKEY           (0xF1)
#define FLASH_COM_CFG_CLOUD_DEVKEY_LEN         (0x10)

#define FLASH_COM_CFG_CLOUD_ACTIVE            (0x101)
#define FLASH_COM_CFG_CLOUD_ACTIVE_LEN         (0x2)

#define FLASH_COM_CFG_CLOUD_SERVER_URL        (0x103)
#define FLASH_COM_CFG_CLOUD_SERVER_URL_LEN     (0x30)

#define FLASH_COM_CFG_CLOUD_PRODUCT_ID        (0x133)
#define FLASH_COM_CFG_CLOUD_PRODUCT_ID_LEN     (0x10)

#define FLASH_COM_CFG_CLOUD_PRODUCT_KEY       (0x143)
#define FLASH_COM_CFG_CLOUD_PRODUCT_KEY_LEN     (0x10)

#define FLASH_COM_CFG_CLOUD_FOTA_MAJORVER      (0x153)
#define FLASH_COM_CFG_CLOUD_FOTA_MAJORVER_LEN       (1)

#define FLASH_COM_CFG_CLOUD_FOTA_MINORVER      (0x154)
#define FLASH_COM_CFG_CLOUD_FOTA_MINORVER_LEN       (1)

#define FLASH_COM_CFG_CLOUD_FOTA_IMGSIZE         (0x155)
#define FLASH_COM_CFG_CLOUD_FOTA_IMGSIZE_LEN          (4)

#define FLASH_COM_CFG_CLOUD_FOTA_UPDATEFLAG  (0x159)
#define FLASH_COM_CFG_CLOUD_FOTA_UPDATEFLAG_LEN   (4)

#define FLASH_COM_CFG_RESERVE_4                (0x15D)
...
#define FLASH_STA_CFG_4WAY_PMK_LEN            (0x20)
