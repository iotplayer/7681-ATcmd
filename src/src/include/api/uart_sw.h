...
typedef struct {
    uint8                      *rx_buffer;   /* data buffer */
    uint8                      *tx_buffer;   /* data buffer */
...
void mt7681_uart_pin_set(void) XIP_ATTRIBUTE(".xipsec0");

/*UART customize*/
void iot_uart_init(void) XIP_ATTRIBUTE(".xipsec0");
void uart_cfg_fr_flash(void) XIP_ATTRIBUTE(".xipsec0");
