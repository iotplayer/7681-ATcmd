...
typedef struct __BUFFER_INFO {
    uint16    Read;        /* @field Current Read index. */
    uint16    Write;        /* @field Current Write index. */
    uint16    Length;        /* @field Length of buffer */
...
/* void Get32FromBuff(BUFFER_INFO *Buf,uint32 DATA) */
...
/*void Put32toBuff(BUFFER_INFO *Buf,uint32 *DATA)*/
