...
FUNCFLAGS	+=	-DATCMD_SOFTAP_SUPPORT=1
FUNCFLAGS	+=	-DATCMD_GET_VER_SUPPORT=1
FUNCFLAGS	+=	-DATCMD_SET_SMNT_SUPPORT=0    #AP Mode has no Smnt
...
FUNCFLAGS	+=	-DCRYPTWEP_SUPPORT=0          #not support in AP mode
FUNCFLAGS	+=	-DCFG_SUPPORT_4WAY_HS=1       #support in AP mode
FUNCFLAGS	+=	-DCFG_SUPPORT_TCPIP=1
FUNCFLAGS	+=	-DCONFIG_SOFTAP=1
FUNCFLAGS	+=	-DCFG_SUPPORT_MTK_SMNT=0      #must off if CONFIG_SOFTAP=1
