...
FUNCFLAGS	+=	-DMT7681_POWER_SAVING=0     #STA power saving mode as Specification said,recovery mode should not use
...
FUNCFLAGS	+=	-DATCMD_UART_SUPPORT=1
FUNCFLAGS	+=	-DATCMD_UART_FW_SUPPORT=1     #Only available while ATCMD_RECOVERY_SUPPORT=1
FUNCFLAGS	+=	-DATCMD_CH_SWITCH_SUPPORT=1
FUNCFLAGS	+=	-DATCMD_NET_MODE_SUPPORT=1
FUNCFLAGS	+=	-DATCMD_REBOOT_SUPPORT=1
FUNCFLAGS	+=	-DATCMD_GET_VER_SUPPORT=1
FUNCFLAGS	+=	-DATCMD_SET_SMNT_SUPPORT=0
...
FUNCFLAGS	+=	-DOVERLAY_ENABLE=0          #xip_ovly.h  Need disabled in recovery mode
FUNCFLAGS	+=	-DEP_CFM=1
FUNCFLAGS	+=	-DEP_LOAD_SUPPORT=1
FUNCFLAGS	+=	-DRX_CLASS123=0
FUNCFLAGS	+=	-DCRYPTWEP_SUPPORT=0
FUNCFLAGS	+=	-DCFG_SUPPORT_4WAY_HS=0
FUNCFLAGS	+=	-DCFG_SUPPORT_TCPIP=0
