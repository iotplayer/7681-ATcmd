...
sta_bin=out${XIPSIZE}/sta/MT7681_sta.bin
sta_ram_bin=out${XIPSIZE}/sta/MT7681_sta_ram.bin
sta_xip_bin=out${XIPSIZE}/sta/MT7681_sta_xip.bin
sta_overlay_bin=out${XIPSIZE}/sta/MT7681_sta_overlay.bin

ap_bin=out${XIPSIZE}/ap/MT7681_ap.bin
ap_ram_bin=out${XIPSIZE}/ap/MT7681_ap_ram.bin
ap_xip_bin=out${XIPSIZE}/ap/MT7681_ap_xip.bin
ap_overlay_bin=out${XIPSIZE}/ap/MT7681_ap_overlay.bin

all_bin=MT7681_all_xip164.bin
loader_bin=refbin/MT7681_loader_xip164.bin
eep_bin=refbin/MT7681E2_EEPROM_layout_20140330.bin
recovery_bin=out${XIPSIZE}/recovery/MT7681_recovery_old.bin
sta_bin=out${XIPSIZE}/sta/MT7681_sta.bin
ap_bin=out${XIPSIZE}/ap/MT7681_ap.bin
